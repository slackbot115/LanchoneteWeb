...
Route::delete('tipoproduto/delete/{id}', "App\Http\Controllers\TipoProdutoController@destroy")->name('tipoproduto.destroy');
...
Route::delete('produto/delete/{id}', "App\Http\Controllers\ProdutoController@destroy")->name('produto.destroy');
