    ...
    <div class="container">
        <form method="POST" action="{{route("tipoproduto.store")}}">
            ...
            <div class="form-group">
              ...
              <input name="id" type="text" class="form-control" id="idTipoProduto" placeholder="#" disabled>
            ...
            <div class="form-group">
                ...
                <input name="descricao" type="text" class="form-control" id="descricaoTipoProduto" placeholder="Digite a descrição do produto...">
            </div>
            <div class="my-1">
